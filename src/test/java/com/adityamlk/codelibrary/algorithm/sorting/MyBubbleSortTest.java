...
public class MyBubbleSortTest {
    ...
    private final MyBubbleSort<Integer> myBubbleSort = new MyBubbleSort<>();
    ...
    private void sortLists(final int valueCount) {
        ...
        myArrayList = (ArrayList<Integer>) myBubbleSort.doSort(myArrayList);
        ...
        log.info(
                "Time to sort {} values with my bubble sort: {} vs default sort: {}.",
                valueCount,
