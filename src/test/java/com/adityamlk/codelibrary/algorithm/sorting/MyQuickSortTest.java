...
public class MyQuickSortTest {
    ...
    private final MyQuickSort<Integer> myQuickSort = new MyQuickSort<>();
    ...
    private void sortLists(final int valueCount) {
        ...
        myArrayList = (ArrayList<Integer>) myQuickSort.doSort(myArrayList);
        ...
        log.info(
                "Time to sort {} values with my quick sort: {} vs default sort: {}.",
                valueCount,
