...
public class MySelectionSortTest {
    ...
    private final MySelectionSort<Integer> mySelectionSort = new MySelectionSort<>();
    ...
    private void sortLists(final int valueCount) {
        ...
        myArrayList = (ArrayList<Integer>) mySelectionSort.doSort(myArrayList);
        ...
        log.info(
                "Time to sort {} values with my selection sort: {} vs default sort: {}.",
                valueCount,
