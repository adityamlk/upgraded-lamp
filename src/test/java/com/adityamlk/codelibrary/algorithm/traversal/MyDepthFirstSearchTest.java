...
public class MyDepthFirstSearchTest {
    ...
    private final MyDepthFirstSearch<String> myDepthFirstSearch = new MyDepthFirstSearch<>();
    ...
    public void doesPathExistWithInvalidStartNodeTest() {
        ...
        final boolean result = myDepthFirstSearch.doesPathExist("blah", "brown", myGraph);
    ...
    public void doesPathExistWithInvalidEndNodeTest() {
        ...
        final boolean result = myDepthFirstSearch.doesPathExist("red", "blah", myGraph);
    ...
    public void doesPathExistBetweenIsolatedSubGraphsTest() {
        ...
        final boolean result = myDepthFirstSearch.doesPathExist("red", "brown", myGraph);
    ...
    public void doesPathExistWithSameStartAndEndTest() {
        ...
        final boolean result = myDepthFirstSearch.doesPathExist("orange", "orange", myGraph);
    ...
    public void doesPathExistWithShortPathTest() {
        ...
        final boolean result = myDepthFirstSearch.doesPathExist("orange", "black", myGraph);
    ...
    public void doesPathExistWithLongPathTest() {
        ...
        final boolean result = myDepthFirstSearch.doesPathExist("orange", "yellow", myGraph);
